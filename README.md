...
Nekoyomi is an independent Android anime and manga application built on top of Aniyomi, which is based on Mihon.
...
Prioritize your preferred sources.
...
Sort anime by times watched.

Track rereads and rewatches.
...
Adjust navigation opacity and icon size.

Pick from several app icons, including community art-contest designs.

Display a customizable blurred cover backdrop.
...
Sequential extension installation.

Clear signature-mismatch warnings.

Source priority and filtering tools for migration.

Download and installation

Official Nekoyomi builds are published on the GitHub releases page.

Open the latest release.

Download the universal APK unless you know which architecture your device uses.

Open the downloaded file.

Allow installation from your browser or file manager if Android requests permission.
...
Some older emulators and x86 devices

x86_64

Compatible 64-bit emulators and x86 devices
...
Your library and settings should remain available, but creating a backup before major updates is strongly recommended.

SHA-256 checksums are included in each release so downloaded APKs can be verified.
...
Application bugs can be reported through GitHub Issues.
...
Join the official Nekoyomi Discord server to talk about the app, get help, report bugs, suggest features and follow development.

Nekoyomi is also listed on Miyomi.
...
Nekoyomi is built on the work of the Aniyomi, Mihon and Tachiyomi projects.
...
Users are responsible for how they configure and use the application and for complying with the laws applicable in their country.

Third-party repositories, extensions and services are maintained independently and are not under Nekoyomi's control.

License

Nekoyomi is licensed under the Apache License 2.0.
