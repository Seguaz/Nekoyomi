...
private fun ColumnScope.GroupPage(
    ...
    val groupMode by screenModel.libraryPreferences.libraryGroupModeAnime().collectAsState()
    val modes = listOf(
    ...
    modes.forEach { (mode, label) ->
        RadioItem(
            ...
            onClick = { screenModel.libraryPreferences.libraryGroupModeAnime().set(mode.ordinal) },
        )
    }
}
